...
public class CheckPassword {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/CheckPassword");
		...
		System.out.println(" Check Password Request ::"+ content);
		...
		reader2.close();
		System.out.println(" Check Password Response ::"+ response2.toString());
	}
