...
public class ApplyDownloadBitrate {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/ApplyDownloadBitrate");
		...
		object.put("mediaIds", "{000000000000000006617}");	
        String content = object.toString();
 	    System.out.println(" ApplyDownloadBitrate Request ::"+content);	
		...
		reader2.close();
		System.out.println("ApplyDownloadBitrate Response ::"+ response2.toString());
