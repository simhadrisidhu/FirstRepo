...
public class ModifyProfile {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/ModifyProfile");	
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		object.put("name", "sitreddy test profile");	 //Mandatory
		object.put("id", "profileId"); // Mandatory	
		//object.put("levels", "4");	
        String content = object.toString();
 	    System.out.println(" ModifyProfile Request ::"+content);	
		...
		reader2.close();
		System.out.println(" ModifyProfile Response::"+ response2.toString());
