...
public class ApplyEPGBitrate {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/ApplyEPGBitrate");
 	...
 	System.out.println(" ApplyEPGBitrate Request ::"+content);	
		...
		reader2.close();
		System.out.println(" ApplyEPGBitrate Response ::"+ response2.toString());
	}
