...
public class QueryHotProgram {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/QueryHotProgram");
 	...
 	System.out.println(" QueryHotProgram Request ::"+content);	
		...
		reader2.close();
		System.out.println(" QueryHotProgram ::"+ response2.toString());
	}
