...
public class GetWANAvailChannel {

	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/GetWANAvailChannel");
        ...
        String content = object.toString();
 	    System.out.println(" GetWANAvailChannel Request ::"+content);	
		...
		reader2.close();
		System.out.println(" GetWANAvailChannel Response ::"+ response2.toString());
