...
public class SwitchProfile {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/SwitchProfile");
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		object.put("password","e5048e16");
		object.put("id","profile id"); //Mandatory
		String content = object.toString();
		System.out.println(" SwitchProfile Request ::"+ content);
		...
		reader2.close();
		System.out.println(" SwitchProfile Response ::"+ response2.toString());
	}
