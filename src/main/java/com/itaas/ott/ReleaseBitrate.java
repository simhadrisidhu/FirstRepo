...
public class ReleaseBitrate {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/ReleaseBitrate");
		...
		object.put("releaseMode", 0);	
     String content = object.toString();
 	System.out.println(" ReleaseBitrate Request ::"+content);	
		...
		reader2.close();
		System.out.println("ReleaseBitrate Response ::"+ response2.toString());			
	}
