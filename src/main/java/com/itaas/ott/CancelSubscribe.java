...
public class CancelSubscribe {
	...
	public static void main(String[] args,String subscriberId) throws ClientProtocolException, IOException {

		
			HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/CancelSubscribe");
			HttpResponse httpResponse2 = null;
			DefaultHttpClient httpClient2 = new DefaultHttpClient();
			httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
			JSONObject object = new JSONObject();
			      //object.put("productid","1000001068");
			  object.put("productid",subscriberId);
					object.put("continuetype", 0);
					object.put("businesstype",2);
					
					String content = object.toString();
					System.out.println(" Cancel Subscription Request::"+ content);
					...
					reader2.close();
					System.out.println(" Cance Subscription Response::"+ response2.toString());
