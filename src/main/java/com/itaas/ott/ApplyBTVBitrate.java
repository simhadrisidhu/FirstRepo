...
public class ApplyBTVBitrate {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/ApplyBTVBitrate");
 	...
 	System.out.println(" ApplyBTVBitrate Request ::"+content);	
		...
		reader2.close();
		System.out.println(" ApplyBTVBitrate Response ::"+ response2.toString());
	}
