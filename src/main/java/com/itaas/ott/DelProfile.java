...
public class DelProfile {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/DelProfile");	
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		object.put("transferBalance", 1);	
		object.put("id", "profileId");   //Mandatory	
        String content = object.toString();
 	    System.out.println(" DelProfile Request ::"+content);	
		...
		reader2.close();
		System.out.println(" DelProfile Response::"+ response2.toString());
