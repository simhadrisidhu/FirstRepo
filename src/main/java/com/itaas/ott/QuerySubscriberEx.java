...
public class QuerySubscriberEx {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/QuerySubscriberEx");
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		object.put("userType",1);
		//object.put("profileId","profile id"); 
		String content = object.toString();
		System.out.println(" QuerySubscriberEx Request ::"+ content);
		...
		reader2.close();
		System.out.println(" QuerySubscriberEx Response ::"+ response2.toString());
	}
