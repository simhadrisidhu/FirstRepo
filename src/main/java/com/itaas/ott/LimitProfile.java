...
public class LimitProfile {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/LimitProfile");	
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		//object.put("actionType", 0);	
		object.put("id", "profileId");   //Mandatory	
		//object.put("levels", "4");	
        String content = object.toString();
 	    System.out.println(" LimitProfile Request ::"+content);	
		...
		reader2.close();
		System.out.println(" LimitProfile Response::"+ response2.toString());
