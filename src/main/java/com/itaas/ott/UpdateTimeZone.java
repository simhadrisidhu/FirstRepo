...
public class UpdateTimeZone {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/UpdateTimeZone");
		
		HttpResponse httpResponse2 = null;
		DefaultHttpClient httpClient2 = new DefaultHttpClient();
		httpPost1.setHeader("Cookie", "JSESSIONID="+args[0]);
		JSONObject object = new JSONObject();
		object.put("newTimezone","NEW TIME ZONE"); // MANDATORY
		String content = object.toString();
		System.out.println(" UpdateTimeZone Request ::"+ content);
		...
		reader2.close();
		System.out.println(" UpdateTimeZone Response ::"+ response2.toString());
	}
