...
public class GetStreamMgmtUrl {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {
		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/GetStreamMgmtUrl");	
		...
		reader2.close();
		System.out.println(" GetStreamMgmtUrl Response::"+ response2.toString());
	}
