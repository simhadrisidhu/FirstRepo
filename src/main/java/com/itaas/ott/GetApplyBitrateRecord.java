...
public class GetApplyBitrateRecord {
	
	public static void main(String[] args) throws ClientProtocolException, IOException {

		
		HttpPost httpPost1 = new HttpPost("http://221.226.2.232:17200/EPG/JSON/GetApplyBitrateRecord");
 	...
 	System.out.println(" GetApplyBitrateRecord Request ::"+content);	
		...
		reader2.close();
		System.out.println("GetApplyBitrateRecord Response ::"+ response2.toString());
