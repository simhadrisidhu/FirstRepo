...
public class ContentLocked {
	
	public static void main(String[] args,String channelId) throws ClientProtocolException, IOException {
		...
		System.out.println(" ContentLocked Request ::"+ content);
		...
		reader2.close();
		System.out.println(" ContentLocked Response ::"+ response2.toString());
	}
